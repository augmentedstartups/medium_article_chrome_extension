...
```
Block 1: Paragraph → Insert text
Block 2: Image → Upload image at this position
Block 3: Paragraph → Insert text
Block 4: Paragraph → Insert text  
Block 5: Image → Upload image at this position
Block 6: Heading → Insert text
... and so on
```
...
```
[File Upload Strategy] Processing blocks IN ORDER: text → image → text → image...
[File Upload Strategy] Block 1/32: p
[File Upload Strategy] → Inserting text block (p)
[File Upload Strategy] Block 2/32: image
[File Upload Strategy] → ⏭️  Skipping first image (used as thumbnail)
[File Upload Strategy] Block 3/32: p
[File Upload Strategy] → Inserting text block (p)
[File Upload Strategy] Block 4/32: image
[File Upload Strategy] → 🖼️  Uploading image 2 at position 4...
[File Upload Strategy] → ✅ Image 2 uploaded (1 total body images)
[File Upload Strategy] Block 5/32: h2
[File Upload Strategy] → Inserting text block (h2)
... continues for all blocks ...
[File Upload Strategy] 🎯 Uploading final CTA image...
[File Upload Strategy] ═══════════════════════════════════════
[File Upload Strategy] ✅ SUCCESS!
...
### Image Positioning
✅ Images appear exactly where they are in the original article
✅ Text flows naturally around images
✅ Matches Medium article structure perfectly

### First Image Handling
✅ First image automatically skipped (already used as thumbnail)
✅ Subsequent images uploaded in body at correct positions
...
Body:
  → Paragraph: "I recently met..."
  → [first image skipped - already used as cover]
  → Paragraph: "They were using AI..."
  → Image: second-image.png (uploaded here)
  → Heading: "From a Single AI Agent..."
  → Paragraph: "When I first approached..."
  → Image: CTA (uploaded at end)
```
...
- Image uploads: ~15-25 seconds (5 images × 3-5s each)
...
- **v1.5.3**: Sequential block insertion ← **Current**
